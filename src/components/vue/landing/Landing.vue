		...
		<div v-if="sidebarActive" id="landing-sidebar">
			...
			<div>
				...
				<div class="buttons social-buttons">
					<a href="https://twitter.com/txstreetCom" target="_blank" class="button is-twitter"><span
							class="fab fa-twitter"></span></a>
					<a href="https://bit.ly/3rWCRm6" target="_blank" class="button is-discord"><span
							class="fab fa-discord"></span></a>
				</div>
				<h2>Links</h2>
				<div class="buttons social-buttons">
					<a href="https://txstreet.com" target="_blank" class="button is-primary">TxStreet</a>
					<a href="https://github.com/txstreet/txstreet" target="_blank" class="button is-link"><span
